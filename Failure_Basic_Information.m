function Failure_Basic_Information

    mpc=case118; %case118;case2383wp;case1888rte;case1354pegase

%     load('IEEE118_Capacity_1_2_InitFail_3_Train_Balanced.mat','cascade_train')
    
%     load('IEEE1354_Capacity_1_InitFail_2_Train_Balanced.mat','cascade_train')
%     load('IEEE1354_Capacity_1_Flow_2_InitFail_2_Train_Balanced_New.mat','cascade_train')

%     load('IEEE1888_Capacity_1_InitFail_2_New_Train_Tmp_3.mat','cascade_train')
...
%     load('IEEE1354_Capacity_1_Flow_1_InitFail_2_Train_Balanced_New_AC.mat','cascade_link_cum')
...
%         state_series_tensor{i}=state_series;
    ...
    for i=1:Train_num %We need to fix the set to estimate the link failure frequency
...
%     Result=[num_generator,num_link,num_eff_link,eff_rate,fail_size_record_avg,fail_size_record_max,fail_size_record_min]
